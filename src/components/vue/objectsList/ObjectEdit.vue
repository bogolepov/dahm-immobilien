...
import { PROPERTY_STATUSES, type ActionType, type PropertyStatus } from '@scripts/supabase_types';
...
import PictureIcon from '@vue/icons/PictureIcon.vue';
			...
			<div class="edit-layer-body">
				<div class="category-list prop-cover-image">
					<div class="cover-image-preview">
						...
						<template v-else>
							<img v-if="updatedObject.url_image" :src="updatedObject.url_image" alt="" />
							<PictureIcon v-else />
						</template>
				...
				<div class="category-list status eye-edit">
					...
					<select v-model="updatedObject.status" class="list-select">
						...
						<option v-for="option in PROPERTY_STATUSES" :value="option">
							{{ statusList[option] }}
						</option>
					</select>
				</div>
